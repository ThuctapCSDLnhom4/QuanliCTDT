...
//                AppRendered.loadData();
    ...
    setEdit: function (title, obj) {
        ...
        else
        {
            ...
            $("#SUBJECTODE").val(obj.SUBJECTCODE);
            $("#STUDENTCODE").val(obj.STUDENTCODE);
            $("#USEDCREDIT").val(obj.USEDCREDIT);
            $("#REGISTRATIONDATE").val(obj.REGISTRATIONDATE);
            $("#EDUCATIONPROGRAMCODE").val(obj.EDUCATIONPROGRAMCODE);
        ...
        return (
            //Hiển thị một phần tử trên danh sách
			  <tr>
				  ...
				  <td>{this.props.item.SUBJECTCODE}</td>
				  <td>{this.props.item.STUDENTCODE}</td>
				  <td>{this.props.item.USEDCREDIT}</td>
				  <td>{this.props.item.REGISTRATIONDATE}</td>
                    <td>{this.props.item.EDUCATIONPROGRAMCODE}</td>
				  <td>
...
var NewRow = React.createClass({
    ...
    handleSubmit: function () {
        ...
        var SUBJECTCODE = this.refs.SUBJECTCODE.getDOMNode().value;
        console.log("subjectcode");

        var STUDENTCODE = this.refs.STUDENTCODE.getDOMNode().value;
        console.log("studentcode");

        var USEDCREDIT = this.refs.USEDCREDIT.getDOMNode().value;
        

        var REGISTRATIONDATE = this.refs.REGISTRATIONDATE.getDOMNode().value;
        console.log("registrationdate");

        var EDUCATIONPROGRAMCODE = this.refs.EDUCATIONPROGRAMCODE.getDOMNode().value;
        console.log("educationprogramcode");
            ...
            <form className="form-horizontal">
                                            <div className="box-body">
                                                <div className="form-group col-sm-12">
                                                 ...
                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Mã môn học</label>
                                                    <div className="col-sm-8">
                                                        <input type="text" className="form-control" ref="SUBJECTCODE" id="SUBJECTCODE" />
                                                    </div>
                                                 </div>
                                                 ...
                                                 <div className="form-group col-sm-12">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <input type="text" ref="STUDENTCODE" id="STUDENTCODE" />
                                                    </div>
                                                 </div>


                                                  <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Số tín chỉ đã sử dụng</label>
                                                    <div className="col-sm-8">
                                                        <textarea ref="text" id="USEDCREDIT" name="USEDCREDIT" rows="10"  className="col-sm-12" ></textarea>
                                                    </div>
                                                  </div>
                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Ngày đăng ký</label>
                                                    <div className="col-sm-8">
                                                        <input type="datetime" className="form-control" ref="REGISTRATIONDATE" id="REGISTRATIONDATE" />
                                                    </div>
                                                 </div>
                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Mã chương trình đào tạo</label>
                                                    <div className="col-sm-8">
                                                        <input type="text" className="form-control" ref="EDUCATIONPROGRAMCODE" id="EDUCATIONPROGRAMCODE" />
                                                    </div>
                                                 </div>
