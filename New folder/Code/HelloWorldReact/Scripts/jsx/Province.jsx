...
//                AppRendered.loadData();
    ...
    setEdit: function (title, obj) {
        this.refs.NEWROWFORM.setEdit(title, obj);
        ...
        //    this.refs.POSTCODE.value = obj.POSTCODE;
        //    this.refs["MAILCODE"].value = obj.MAILCODE;
        //}
    ...
    clearInput: function () {
        this.refs.NEWROWFORM.clearInput();
    ...
    render: function () {
        ...
        return (
			<div>
				...
				<NewRow onRowSubmit={this.handleNewRowSubmit} ref="NEWROWFORM" />
            ...
            //Hiển thị một phần tử trên danh sách
			  <tr>
				  ...
				  <td>{this.props.item.NAME}</td>
                    ...
                    <td>{this.props.item.MAILCODE}</td>
				  <td>
...
var NewRow = React.createClass({
    ...
    clearInput: function () {
        ...
        this.refs.MAILCODE.getDOMNode().value = "";
        //$("#POSTCODE").val('');
        //$("#MAILCODE").val('');
        //this.refs.POSTCODE.value = '';
        //this.refs["MAILCODE"].value = '';
        console.log('Finish clear input', this.refs.POSTCODE);
    ...
    setEdit: function (title, obj) {
        ...
        if (obj === '') {
            ...
            $("#LOCK").prop('checked', (obj.LOCK == 1));
            this.refs.POSTCODE.getDOMNode().value = obj.POSTCODE;
            this.refs.MAILCODE.getDOMNode().value = obj.MAILCODE;
            //this.refs.POSTCODE.value = obj.POSTCODE;
            //this.refs["MAILCODE"].value = obj.MAILCODE;
        }
        $("#UpdateModal").modal("show");
    ...
    handleSubmit: function () {
        ...
        console.log("lock");
        var POSTCODE = this.refs.POSTCODE.getDOMNode().value;
        var MAILCODE = this.refs.MAILCODE.getDOMNode().value;
                                                  ...
                                                  <div className="form-group col-sm-12">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <textarea ref="NOTE" id="NOTE" name="NOTE" rows="10"  className="col-sm-12" ></textarea>
                                                                                                 ...
                                                                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Mã hòm thư</label>
                                                    <div className="col-sm-8">
                                                        <input type="text" className="form-control" ref="POSTCODE" id="POSTCODE" />
                                                    </div>
                                                                                                 </div>
                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Mã điện thoại</label>
                                                    <div className="col-sm-8">
                                                        <input type="text" className="form-control" ref="MAILCODE" id="MAILCODE" />
                                                    </div>
                                                 </div>
