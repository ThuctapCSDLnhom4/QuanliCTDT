...
namespace HelloWorldReact.Controllers
{
    ...
    public class BranchController : Controller
    {
        ...
        public JsonResult delete(string id)
        {
            ...
            int ret = 0;
            BRANCH_BUS bus = new BRANCH_BUS();
            BRANCH_OBJ obj = bus.GetByID(new BRANCH_OBJ.BusinessObjectID(id));
        ...
        /// </summary>
        public JsonResult update(BRANCH_OBJ obj, string keysearchCodeView, string keysearchName)
        {
            if (ses.func("ADMINDIRE") <= 0)
            {
                return Json(new { sussess = -3 }, JsonRequestBehavior.AllowGet);
            ...
            BRANCH_OBJ obj_temp = null;
            //kiểm tra tồn tại cho trường hợp sửa
            if (!string.IsNullOrEmpty(obj.CODE))//edit
            {
                obj_temp = bus.GetByID(new BRANCH_OBJ.BusinessObjectID(obj.CODE));
