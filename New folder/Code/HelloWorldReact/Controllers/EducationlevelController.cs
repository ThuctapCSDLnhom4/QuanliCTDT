...
namespace HelloWorldReact.Controllers
{
    ...
    public class EducationlevelController : Controller
    {
        ...
        {
            List<EDUCATIONLEVEL_OBJ> li = null;
            ...
            EDUCATIONLEVEL_BUS bus = new EDUCATIONLEVEL_BUS();
        ...
        public JsonResult delete(string id)
        {
            ...
            int ret = 0;
            EDUCATIONLEVEL_BUS bus = new EDUCATIONLEVEL_BUS();
            EDUCATIONLEVEL_OBJ obj = bus.GetByID(new EDUCATIONLEVEL_OBJ.BusinessObjectID(id));
        ...
        /// </summary>
        public JsonResult update(EDUCATIONLEVEL_OBJ obj, string keysearchCodeView, string keysearchName)
        {
            if (ses.func("ADMINDIRE") <= 0)
            {
                return Json(new { sussess = -3 }, JsonRequestBehavior.AllowGet);
            ...
            EDUCATIONLEVEL_OBJ obj_temp = null;
            //kiểm tra tồn tại cho trường hợp sửa
            if (!string.IsNullOrEmpty(obj.CODE))//edit
            {
                obj_temp = bus.GetByID(new EDUCATIONLEVEL_OBJ.BusinessObjectID(obj.CODE));
            ...
            {
                obj_temp = new EDUCATIONLEVEL_OBJ();
            }
